...
Contributions to `symmray` in the form of
[pull requests](https://github.com/jcmgray/symmray/pulls) are very welcome.
Opening an [issue](https://github.com/jcmgray/symmray/issues) first can be
...
[development guide](https://symmray.readthedocs.io/en/latest/develop.html)
