...
class AbelianArrayFlat(
    ...
    def svd_via_eig_truncated(
        ...
        **kwargs,
        ...
        using eigen-decomposition of the gram matrix (xdag @ x or x @ xdag).
        This can be faster, but also incur a loss of precision due to the
        squaring.
    ...
    def svd_via_eig(self):
        """Singular value decomposition of this flat abelian array, using
